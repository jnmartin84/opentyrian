 ...
 *        the text.)
 */
void draw_font_hv_shadow(uint8_t *surface, int x, int y, const char *text, Font font, FontAlignment alignment, Uint8 hue, Sint8 value, bool black, int shadow_dist)
{
 ...
 */
void draw_font_hv_full_shadow(uint8_t *surface, int x, int y, const char *text, Font font, FontAlignment alignment, Uint8 hue, Sint8 value, bool black, int shadow_dist)
{
 ...
 * @param value value component of text color
 */
void draw_font_hv(uint8_t *surface, int x, int y, const char *text, Font font, FontAlignment alignment, Uint8 hue, Sint8 value)
{
	switch (alignment)
	{
	case left_aligned:
 ...
 * @param value value component of text color
 */
void draw_font_hv_blend(uint8_t *surface, int x, int y, const char *text, Font font, FontAlignment alignment, Uint8 hue, Sint8 value)
{
	switch (alignment)
	{
	case left_aligned:
